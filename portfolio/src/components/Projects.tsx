      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {projects.map((proj) => (
            <div 
              key={proj.id} 
              className="group relative h-[450px] rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl overflow-hidden transition-all duration-500 hover:border-white/30 hover:bg-white/10 flex flex-col justify-end p-10 cursor-pointer shadow-2xl"
            >
              ...
              <Image 
                ...
                alt={proj.title} 
                fill 
                className="object-cover absolute inset-0 z-0 opacity-40 group-hover:opacity-60 group-hover:scale-105 transition-all duration-700" 
              />
